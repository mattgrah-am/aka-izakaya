  ...
  section.innerHTML = `
    <div class="container w-75">
      <div class="title_header pt-5 pb-4">
        ...
        Produce is often only lightly cooked and what and how people cook is highly influenced by the seasons.</p>
      </div>
    ...
    <div class="container w-75">
      <div class="title_header pt-5 pb-4">
        <h3 class="catagory text-uppercase">${type} Menu</h3>
        <p class="desc">Our drinks selection features barrel-aged Japanese whiskey as well as premium Sake from the regions of Nada and Fushimi. You’ll also find a diverse selection of beers, wines and spirits, so you can order an old favourite or ask our bartenders for a recommendation to suit your meal. 
        </p>
      </div>
    <div id="foodMenu" class="menu-container mb-5"></div>`;
  }
